...
import Image2 from "../../images/aboutus/section2-top.png";
const Section2 = () => {
  return (
    <>
      <div className="row p-md-5 p-3">
        <div className="col-md-6 col-12 justify-content-center align-items-center d-flex">
          <div className="parent-div-section2">
            <div className="img-backg-img1-blue">
              <img src={Image2} alt="" className="img-backg-img2" />
            </div>
          </div>
        </div>
