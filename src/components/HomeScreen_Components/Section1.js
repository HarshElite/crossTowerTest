        ...
        <div className="row p-md-5 w-100">
          <div className="col-md-6 col-sm-12 d-flex justify-content-center align-items-center p-3">
            <div>
              ...
              <p className="generic-title-heading primary-color-blue">
                Buy & sell Crypto in minutes
              </p>
              <p className="generic-para-text primary-color-blue">
                Launching The India's most powerful crypto Platform you Join the
